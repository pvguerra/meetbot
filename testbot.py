...
def button(bot, update):
    ...
    if query.data == '1':
        ...
        bot.sendMessage(text="Presença confirmada: {} ".format(lista_presença),
...
def help(bot, update):
    update.message.reply_text("Use /marcar_reuniao para marcar reunia.")
...
def main():
    ...
    updater.dispatcher.add_handler(CommandHandler('marcar_reuniao', marcar_reuniao))
